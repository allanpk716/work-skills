...
- [x] **S01: Config Detection & Smart Interaction** `risk:medium` `depends:[]`
  > After this: unit tests prove Config Detection & Smart Interaction works
- [x] **S02: Unified Flow Integration** `risk:medium` `depends:[S01]`
  > After this: unit tests prove Unified Flow Integration works
