...
tags: [git, subprocess, worktree, flags, title-formatting]

# Dependency graph
requires:
  - phase: 30
    provides: flags.py with find_project_root(), get_project_name()
provides:
...
tech-stack:
  added: [subprocess]
  patterns: [git-branch-detection, shared-title-builder, worktree-compatible-path-check]
...
requirements-completed: [WTREE-01]
