...
- [ ] **INS-01**: installer 不再检测/配置 git-ssh、git-user、TortoiseGit、PuTTY (移除 detectors/git.js、detectors/ssh-tools.js、configurators/git-ssh.js、configurators/git-user.js);保留 detectors/python.js、detectors/pip-package.js、configurators/pushover.js
